...
test('3D 游戏宿主复用 VSR 资产流送解析并暴露诊断',()=>{assert.match(game,/resolveSpatialAssetStreaming/);assert.match(game,/assetStreaming:spatial3dAssetStreaming/);assert.match(game,/asset_streaming_root/);assert.match(game,/assetRequestedCount/)});
