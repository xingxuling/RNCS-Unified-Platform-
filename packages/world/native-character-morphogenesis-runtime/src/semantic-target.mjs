...
export function createSemanticMorphologyProfile(targetInput={}){
  ...
  return seal({
    ...
    morphology_law_overrides:{
      hard_constraints:{minimum_head_unit:.055,maximum_head_unit:.13,minimum_body_height:.62,maximum_body_height:1.02},
      anime_stylization_ranges:{head_to_body:[.09,.13],shoulder_to_head:[1.75,2.15],waist_to_shoulder:[.48,.62],hand_to_forearm:[.34,.52]},
      derivation_coefficients:{head_unit_base:.055,head_unit_ratio:.035,shoulder_base:.20,shoulder_ratio:.12,torso_base:.16,torso_ratio:.12,limb_base:.14,limb_ratio:.10,depth_ratio:.45}
    },
