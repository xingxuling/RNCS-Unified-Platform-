...
const report={
  runtime:'0.1.0-alpha.12',node:process.version,platform:process.platform,nodes:count,dynamicNodes:dynamicCount,runs:30,
...
mkdirSync('outputs',{recursive:true});writeFileSync('outputs/benchmark-alpha6.json',JSON.stringify(report,null,2));console.log(JSON.stringify(report,null,2));
