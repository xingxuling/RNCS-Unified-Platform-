...
export const health=()=>({
  ...
  protocols:['vsr.spatial-reality-3d.v0.7','vsr.spatial-asset-streaming.v0.1','vsr.representation-provider.v0.1','vsr.gltf-import.v0.1','vsr.temporal-presentation.v0.6'],
  version:VSR_VERSION
});
...
export async function representationProvider(){return import('../dist/packages/representation-provider/src/index.js');}
