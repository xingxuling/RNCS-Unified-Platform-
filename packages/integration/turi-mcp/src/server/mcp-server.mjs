...
const EXPOSED_COMPATIBILITY_NAMES = new Set([
  ...
  'updia_health', 'updia_status', 'updia_list_organs', 'updia_think', 'updia_research_start', 'updia_research_status', 'updia_memory_search', 'updia_action_propose', 'updia_action_result_ingest',
