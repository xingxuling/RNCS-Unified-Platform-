# Reality Kernel v0.1 verification matrix
...
| RK-06 | Release | package test and demo pass on Node 20+ | package scripts | `npm test && npm run demo` | 8 tests + demo + syntax checks | GREEN |
