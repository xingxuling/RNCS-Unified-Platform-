...
test('URRF Universal Art Asset Forge emits a rooted candidate and closes AAA claims without required evidence', () => {
  ...
  const reportBase = {
    ...
    notes: 'Candidate-only local RAGF reference execution. The forge independently inspects generated GLB accessors, welded indexed topology, UVs, normals, material structure, the external four-map PBR pack, and a contiguous decreasing three-level LOD sequence; Provider quality/art-direction/human-review declarations cannot open those gates, external quality/review receipts are absent, and AAA remains blocked on provenance/license, art-direction, quality-tier and human-review evidence. It is not AAA production art proof or canonical RNCS mutation.'
  };
